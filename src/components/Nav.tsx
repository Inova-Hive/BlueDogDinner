            ...
            <div className="text-center pt-6 pb-4 navbar-shadow">
                ...
                <div className="mt-4 flex justify-between items-center">
                    ...
                    <div className="w-2/3 mx-auto space-x-16 text-center">
                        ...
                        <RouterLink to="/YOUR-ONLINE-ORDERING-URL" target="_blank" className="font-1-semibold text-lg text-custom-red hover:text-custom-blue transition-colors duration-700 underline-effect">ORDER ONLINE</RouterLink>
