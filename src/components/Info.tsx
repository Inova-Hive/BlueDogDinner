    ...
    <div className="py-12 mb-24">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
            ...
            <div className="flex flex-col justify-between items-center  w-full md:w-1/2 lg:w-1/3">
                <p className="text-lg font-1-bold text-custom-blue text-center mb-8"> We offer over 20 different types of hot dogs, each with its unique flavor and ingredients.</p>
